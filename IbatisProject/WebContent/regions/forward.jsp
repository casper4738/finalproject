...
<html:form action="/region">
	<html:hidden property="task" name="regionForm"/>
	<html:hidden property="message" name="regionForm"/>
</html:form>

<logic:equal name="regionForm" property="task" value="insert">
	<script>flyToForward('success', '<bean:message key="label.message.insert"/>')</script>
</logic:equal>

<logic:equal name="regionForm" property="task" value="update">
	<script>flyToForward('success', '<bean:message key="label.message.update"/>')</script>
</logic:equal>

<logic:equal name="regionForm" property="task" value="delete">
