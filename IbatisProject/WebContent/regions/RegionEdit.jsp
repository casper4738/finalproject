...
<body>
	...
	<h1 style="text-align:center"><bean:message key="label.title.region.edit"/></h1>

	<html:form action="/region" onsubmit="return validate()" method="post">
		<html:hidden property="task" name="helloForm" value="update" />
		<html:hidden property="regionBean.regionId" name="regionForm" />
		<table align="center" border="1" cellpadding="10" cellspacing="0">
			<tr>
				<td><bean:message key="label.region.id"/></td>
				<td><html:text name="regionForm" property="regionBean.regionId" disabled="true" /></td>
			</tr>
			<tr>
